...
Then we can recreate our timeseries chart, this time focusing on a shorter time period. Here we also shade in the background according to the stringency of response (see other code in repo), and change the order of the cities according to when the pandemic began. 
